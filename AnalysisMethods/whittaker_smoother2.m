function [z] = whittaker_smoother2(groupy,lambda,d)
% function [z] = whittaker_smoother(groupy,lambda,d)
% 
...
%       08/01/2014, zjs - updated and renamed for higher order differences
